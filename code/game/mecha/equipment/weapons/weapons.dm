...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/slugthrower_shoulder
	...
	desc = "Exosuit Shoulder-Mounted Single-Shot Super-Heavy Slug Launcher... You have no idea what it means, but it is certainly a weapon for combat exosuits. Shoots super-heavy slugs at extremely low speed."
	icon_state = "mecha_carbine"
	energy_drain = 500
	equip_cooldown = 20
...
/obj/projectile/bullet/heavy_slug/super/process()
	. = ..()
	transform *= 4
...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/slugthrower_shoulder/attach(obj/mecha/M as obj)
	..()
	slughthrower_shoulder_overlay = new(src.icon, icon_state = "repair_droid")
